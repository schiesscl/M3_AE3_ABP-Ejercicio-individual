...
# CORRECCIÓN: Se cambiaron los operadores > por >= para incluir casos de borde.
def calculate_discount(qty, times_bought, purchase_total, is_sale_day):
    ...
    # CORREGIDO: Ahora incluye exactamente 10 productos
    if qty >= 10:
        discount += 10
    # CORREGIDO: Ahora incluye exactamente 5 compras previas
    if times_bought >= 5:
        discount += 5
    # CORREGIDO: Ahora incluye exactamente 500 dólares
